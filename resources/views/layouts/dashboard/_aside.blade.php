...
{{--
    @if (auth()->user()->hasPermission('read_users'))
            <li><a href="{{ route('dashboard.ProfitRatio.index') }}"><i class="fa fa-th"></i><span>@lang('site.profit_percent')</span></a></li>
            @endif
            
            --}}
   @if (auth()->user()->hasPermission('read_users'))
            <li><a href="{{ route('dashboard.Paymentcommissions.index') }}"><i class="fa fa-th"></i><span>@lang('site.Paymentcommissions')</span></a></li>
            @endif
